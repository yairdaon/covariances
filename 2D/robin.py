...
dim = 2 # dimentia
k = 2 # number of iterations for ptwise var estimate
...
plot( hom_rob_var, 
      ...
      #range_min = ran[0],
      #range_max = ran[1],
  ).write_png( "../../PriorCov/" + mesh_name + "homogeneous_robin_variance" )
...
plot( neumann_var,
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../../PriorCov/" + mesh_name + "homogeneous_neumann_variance" )
...
plot( imp_rob_var,
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../../PriorCov/" + mesh_name + "improper_robin_variance" )
...
plot( tmp,
  ...
  ).write_png( "../../PriorCov/" + mesh_name + "fundamental_solution" )
...
plot( sol_hom_rob, 
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../../PriorCov/" + mesh_name + "homogeneous_robin_green" )
...
plot( sol_imp_rob, 
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../../PriorCov/" + mesh_name + "improper_robin_green" )
...
plot( sol_neumann,
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../../PriorCov/" + mesh_name + "homogeneous_neumann_green" )

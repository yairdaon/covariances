...
dim = 2 # dimentia
k = 10000 # number of iterations for ptwise var estimate
...
plot( hom_rob_var, 
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../docs/homogeneous_robin_variance" )
...
plot( neumann_var,
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../docs/homogeneous_neumann_variance" )
...
plot( imp_rob_var,
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../docs/improper_robin_variance" )
...
plot( tmp,
  ...
  ).write_png( "../docs/fundamental_solution" )
...
plot( sol_hom_rob, 
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../docs/homogeneous_robin_green" )
...
plot( sol_imp_rob, 
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../docs/improper_robin_green" )
...
plot( sol_neumann,
      ...
      #range_min = ran[0],
      #range_max = ran[1]
  ).write_png( "../docs/homogeneous_neumann_green" )
...
# plot( sol_inhom_rob,
#       title = "Inhomogeneous Robin Greens Function",
#       mode ="color",
#       range_min = ran[0],
#       range_max = ran[1]
#   ).write_png( "../docs/inhomogeneous_robin_green" )


# Saving and plotting and boriiiinnnngggg....
...
# fi = File( 'vis/homogeneous_robin_var.pvd' )
# fi << hom_rob_var
# fi = File( 'vis/improper_robin_var.pvd' )
# fi << imp_rob_var
# fi = File( 'vis/neumann_var.pvd' )
# fi << neumann_var

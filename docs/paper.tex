...
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth]{homogeneous_neumann_green.png}
   \caption*{$\Op = (-\Delta + \kappa^2)^2$, homogeneous Neumann.}
\endminipage\hfill
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth]{homogeneous_robin_green.png}
   \caption*{$\Op = (-\Delta + \kappa^2)^2$, homogeneous Robin.}
\endminipage\hfill

\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth]{improper_robin_green.png}
   \caption*{$\Op = -\Delta + \kappa^2$, homogeneous Robin.}
\endminipage\hfill
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth]{fundamental_solution.png}
...
\minipage{0.33\textwidth}
  \includegraphics[width=\linewidth]{homogeneous_neumann_variance.png}
   \caption*{$\Op = (-\Delta + \kappa^2)^2$, homogeneous Neumann.}
\endminipage\hfill
\minipage{0.33\textwidth}
  \includegraphics[width=\linewidth]{homogeneous_robin_variance.png}
   \caption*{$\Op = (-\Delta + \kappa^2)^2$, homogeneous Robin.}
\endminipage\hfill
\minipage{0.33\textwidth}
  \includegraphics[width=\linewidth]{improper_robin_variance.png}
   \caption*{$\Op = -\Delta + \kappa^2$, homogeneous Robin.}
\endminipage
